...
EFFECT.name = "Среднее кровотечение"

EFFECT.tickInterval = 5
EFFECT.damagePerTick = ix.config.Get("BleedingMedDmg")
EFFECT.maxTicks = 0
...
function EFFECT:OnStart(character, hitgroup)
    ...
    self._timerID = "bleedingmed_" .. tostring(ply:SteamID64()) .. "_" .. tostring(self.uniqueID) .. "_" .. tostring(hitgroup)
