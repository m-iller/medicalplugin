...
EFFECT.name = "Сильное кровотечение"

EFFECT.tickInterval = 1
EFFECT.damagePerTick = ix.config.Get("BleedingMaxDmg")
EFFECT.maxTicks = 0
...
function EFFECT:OnStart(character, hitgroup)
    ...
    self._timerID = "bleedingmax_" .. tostring(ply:SteamID64()) .. "_" .. tostring(self.uniqueID) .. "_" .. tostring(hitgroup)
